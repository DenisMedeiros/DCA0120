...
<template:base>
	...
	<jsp:attribute name="cabecalhoExtra">   
		...
		<link rel="stylesheet" type="text/css"
			href="${pageContext.request.contextPath}/static/css/formulario.css">
		<link rel="stylesheet"
			href="${pageContext.request.contextPath}/static/css/bootstrap-datepicker3.css" />
		<link rel="stylesheet"
			href="${pageContext.request.contextPath}/static/css/parsley.css" />
		<link rel="stylesheet"
			href="${pageContext.request.contextPath}/static/css/telefones.css" />
	</jsp:attribute>
					...
					<div class="cols-sm-10">
						<div class="input-group">
							...
							<input type="text" class="form-control" name="nome" id="nome"
								maxlength="255" placeholder="Digite seu nome"
					...
					<div class="cols-sm-10">
						<div class="input-group">
							...
							<input type="text" class="form-control" name="cpf" id="cpf"
								placeholder="Apenas números" data-parsley-required
								data-parsley-cpf data-parsley-duplicado />
					...
					<div class="phone-list">
						<div>
							<div class="input-group phone-input">
								<span class="input-group-addon"><i
									class="fa fa-envelope fa" aria-hidden="true"></i></span>
								<input type="text" id="telefone_1" name="telefone_1"
									class="form-control" placeholder="Somente números"
									maxlength="11" data-parsley-required data-parsley-type="number" />
							</div>
							<span class="mensagem-ajuda"></span>
						</div>
					</div>
					...
					<div class="cols-sm-10">
						<div class="input-group">
							...
							<input type="password" class="form-control" name="senha1"
								id="senha1" maxlength="64" placeholder="Senha"
								data-parsley-required />
						</div>
						<span class="mensagem-ajuda"></span>
					</div>
	...
	<jsp:attribute name="rodapeExtra">  
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/static/js/bootstrap-datepicker.pt-BR.min.js"></script>
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/static/js/parsley.min.js"></script>
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/static/js/i18n/pt-br.js"></script>
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/static/js/jquery.maskedinput.min.js"></script>
										...
										.addValidator(
												'duplicado',
												{
													validateString : function(
														...
														$
																.ajax({
																	url : "${pageContext.request.contextPath}/verificarCPF?cpf="
																			+ cpf,
																	type : 'GET',
																	async : false,
																	cache : false,
		...
		<script>
			$(function() {
				$(document.body).on(
						...
						'.changeType',
						function() {
							$(this).closest('.phone-input').find('.type-text')
									.text($(this).text());
							$(this).closest('.phone-input').find('.type-input')
